# BIOVID — One Product Store

Landing page estática para BIOVID Regenerador Celular.

- Repo: `craft-clinics-pages/biovid`
- Deploy: Cloudflare Pages vía GitHub Actions
- URL prevista: https://biovid.pages.dev
